...
Industrial surface defect detection benchmark focused on **MVTec AD**, comparing supervised CNN baselines, classical anomaly detection, zero/few-shot vision-language models, and lightweight hybrid fusion strategies.
...
|---|---:|---:|---:|---:|---:|---:|
| ResNet-18 | 0.8574 | 0.7499 | 0.6905 | 0.3095 | — | 50.8 |
...
| PatchCore + WinCLIP k=4 (0.7 / 0.3) | 0.9853 | 0.9773 | 0.9823 | 0.0177 | — | not fully measured |
...
- Supervised inspection underperformed badly on unseen-defect risk
...
```text
download data -> profile categories -> run baseline models
             -> normalize metrics -> compare families
...
scripts/       dataset, training, and benchmarking utilities
...
- remeasure hybrid latency end-to-end
